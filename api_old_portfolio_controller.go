...
func (a *OldPortfolioControllerAPIService) GetPortfolioExecute(r ApiGetPortfolioRequest) (*ComHellopublicUserapigatewayApiRestPortfolioGatewayPortfolioResponse, *http.Response, error) {
	var (
		...
		formFiles            []formFile
		localVarReturnValue  *ComHellopublicUserapigatewayApiRestPortfolioGatewayPortfolioResponse
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "OldPortfolioControllerAPIService.GetPortfolio")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/userapigateway/portfolio"
